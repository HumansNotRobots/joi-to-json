    ...
    _parseSwitchCondition(ifThenStyle, schema, condition, definitions, level) {
        ...
        for (const switchCondition of condition.switch) {
            if (ifThenStyle && !condition.ref) {
                const innerSchema = this._parseIfThenElseCondition({}, switchCondition, definitions, level + 1);
...
let JoiJsonDraftSchemaParser$1 = class JoiJsonDraftSchemaParser extends JoiJsonSchemaParser {
    constructor(opts = {}) {
        super(_.merge({
...
let JoiOpenApiSchemaParser$1 = class JoiOpenApiSchemaParser extends JoiJsonDraftSchemaParser$1 {
    constructor(opts = {}) {
        super(_.merge({
            logicalOpParser: {
                xor: null,
...
class JoiOpenApiSchemaParser extends JoiJsonDraftSchemaParser {
    constructor(opts = {}) {
        super(opts);
        this.$schema = undefined;
    }
...
const parsers = {
    'json-draft-2019-09': JoiJsonDraftSchemaParser,
    'json-draft-04': JoiJsonDraftSchemaParser$1,
    json: JoiJsonSchemaParser,
    'open-api': JoiOpenApiSchemaParser$1,
    'open-api-3.1': JoiOpenApiSchemaParser
};
